...
//		if( mysql_stmt_store_result(mysql_stmt) ) goto sqlerr;
		...
		/*EXEC_SQL UPDATE order_line
				...
				ol_w_id = :w_id;*/
		mytnt_stmt = stmt[t_num][29];

		memset(param, 0, sizeof(MYTNT_BIND) * 4); /* initialize */
		param[0].buffer_type = MYTNT_TYPE_STRING;
